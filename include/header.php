...
<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
            ...
            <div class="main-nav secondary-nav hover-primary-nav py-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo animate__animated animate__slideInDown" src="img_new/logo.png" alt="" style="height: 55px;"></a><b class="animate__animated animate__slideInDown link-dark" style="color:black; font-size:large;"><span><a href="" style="color:black;"> Exclusive Kasi Living </a></span></b>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto ">
										...
										<li class="nav-item dropdown">
											<a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Landlord Registration</a>
										...
										<?php } else { ?>
										<li class="nav-item"> <a class="nav-link" href="login.php">Landlord Registration</a> </li>
										<?php } ?>
                        ...
                        &nbsp;&nbsp;<a style="color: #25d366;" href="https://api.whatsapp.com/send/?phone=270123456789&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" role="button">
